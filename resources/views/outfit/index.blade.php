    ...
    <div class="flex flex-row justify-center align-center w-full">
        ...
        @else
            <div class="flex flex-col">
                <div class="flex mb-5">
                    <a href="/outfits/create" class="py-2 px-4 dark-bg pink font-bold w-fit border-2 border-gray-500 mt-5 rounded">Add clothes</a>
                </div>
                <div class="grid grid-cols-3 gap-4">
                    @foreach ($outfits as $outfit)
                        <x-card :title="$outfit['name']" class="pink-bg">
